...
export default function CategoryList() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("https://api.editezy.com/api/category/create-cateogry", {
        categoryName,
      });
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await axios.delete(`https://api.editezy.com/api/category/delete/${id}`);
  ...
  const handleUpdate = async () => {
    ...
    try {
      const res = await axios.put(
        `https://api.editezy.com/api/category/update/${selectedCategory._id}`,
        { categoryName }
      );
