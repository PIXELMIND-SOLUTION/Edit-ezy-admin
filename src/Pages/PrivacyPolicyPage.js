...
const PrivacyPolicyPage = () => {
    ...
    const fetchPrivacyPolicy = async () => {
      try {
        const response = await axios.get(
          "https://api.editezy.com/api/admin/getpolicy"
        );
  ...
  const handleUpdate = async () => {
    ...
    try {
      setLoading(true);
      await axios.put(
        `https://api.editezy.com/api/admin/updatepolicy/${privacyPolicy._id}`,
        { title, content, date }
      );
  ...
  const handleDelete = async () => {
    ...
    try {
      setLoading(true);
      await axios.delete(
        `https://api.editezy.com/api/admin/deletepolicy/${privacyPolicy._id}`
      );
