              ...
              <Form onSubmit={handleSubmit}>
                ...
                <FormGroup>
                  ...
                  <small className="text-muted d-block mb-2">
                    💡 <strong>Note:</strong> Type in the search box above to filter categories. 
                    The dropdown below will only show categories matching your search. 
                    Clear the search box to see all categories again.
                  </small>
                  <Input
                    id="categoryName"
                    type="select"
