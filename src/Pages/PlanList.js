...
const PlanList = () => {
  ...
  const fetchPlans = async () => {
    try {
      const response = await axios.get("https://api.editezy.com/api/plans/getallplan");
  ...
  const handleSaveChanges = () => {
    ...
    axios
      .put(`https://api.editezy.com/api/plans/update/${selectedPlan._id}`, updatedPlan)
      .then(() => {
  ...
  const handleDelete = (id) => {
    ...
    axios
      .delete(`https://api.editezy.com/api/plans/delete/${id}`)
      .then(() => {
