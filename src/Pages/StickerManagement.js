...
const StickerManagement = () => {
  ...
  const fetchStickers = async () => {
    setLoading(true);
    try {
      const response = await axios.get('https://api.editezy.com/api/admin/allsticker');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editMode) {
        await axios.put(
          `https://api.editezy.com/api/admin/updatesticker/${currentStickerId}`,
          formDataToSend,
          {
        ...
        await axios.post(
          'https://api.editezy.com/api/admin/createsticker',
          formDataToSend,
          {
            headers: { 'Content-Type': 'multipart/form-data' },
          }
  ...
  const handleDelete = async () => {
    setModalLoading(true);
    try {
      await axios.delete(`https://api.editezy.com/api/admin/deletesticker/${currentStickerId}`);
