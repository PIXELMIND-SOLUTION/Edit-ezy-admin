...
const CreateBanner = () => {
  ...
  const fetchBanners = async () => {
    try {
      const res = await axios.get('https://api.editezy.com/api/poster/getbanners');
      setBanners(res.data);
    } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://api.editezy.com/api/poster/createbanner', formData, {
  ...
  const handleUpdate = async () => {
    ...
    try {
      await axios.put(`https://api.editezy.com/api/poster/updatebanner/${editId}`, formData, {
        headers: { 'Content-Type': 'multipart/form-data' },
      });
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://api.editezy.com/api/poster/deletebanner/${id}`);
      fetchBanners();
    } catch (err) {
