...
const AmountSettings = () => {
  ...
  const fetchAllAmounts = async () => {
    ...
    try {
      const response = await axios.get('https://api.editezy.com/api/admin/allamount');
  ...
  const handleAdd = async () => {
    ...
    setLoading(true);
    try {
      const response = await axios.post('https://api.editezy.com/api/admin/setamount', {
        name: name,
  ...
  const handleDelete = async () => {
    setLoading(true);
    try {
      const response = await axios.delete(`https://api.editezy.com/api/admin/amount/${editId}`);
