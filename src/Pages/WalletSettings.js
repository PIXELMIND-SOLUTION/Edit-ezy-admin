...
const WalletSettings = () => {
  ...
  const fetchWalletCoins = async () => {
    ...
    try {
      const response = await axios.get('https://api.editezy.com/api/admin/getwallet');
  ...
  const handleAdd = async () => {
    ...
    setLoading(true);
    try {
      const response = await axios.post('https://api.editezy.com/api/admin/setwallet', {
  ...
  const handleDelete = async () => {
    setLoading(true);
    try {
      const response = await axios.delete('https://api.editezy.com/api/admin/deletewallet');
