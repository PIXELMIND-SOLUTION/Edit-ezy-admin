...
const GetContactUsPage = () => {
  ...
  const fetchContactUsData = async () => {
    try {
      const response = await axios.get("https://api.editezy.com/api/admin/getcontactus");
  ...
  const handleUpdateSubmit = async () => {
    ...
    try {
      await axios.put(
        `https://api.editezy.com/api/admin/updatecontactmessage/${currentMsg._id}`,
        formData
      );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://api.editezy.com/api/admin/deletecontactmessage/${id}`);
