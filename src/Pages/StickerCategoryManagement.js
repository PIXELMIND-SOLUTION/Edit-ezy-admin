...
const StickerCategoryManagement = () => {
  ...
  const fetchCategories = async () => {
    setLoading(true);
    try {
      const response = await axios.get('https://api.editezy.com/api/admin/allsticker-category');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editMode) {
        await axios.put(
          `https://api.editezy.com/api/admin/updatesticker-category/${currentCategoryId}`,
          formDataToSend,
          {
        ...
        await axios.post(
          'https://api.editezy.com/api/admin/createsticker-category',
          formDataToSend,
          {
            headers: { 'Content-Type': 'multipart/form-data' },
          }
        );
        showAlert('Sticker category created successfully!');
      }
      ...
      console.error('Error saving sticker category:', error);
      const errorMessage = error.response?.data?.message || 'Error saving sticker category';
  ...
  const handleDelete = async () => {
    setModalLoading(true);
    try {
      await axios.delete(`https://api.editezy.com/api/admin/deletesticker-category/${currentCategoryId}`);
      ...
      showAlert('Error deleting sticker category', 'danger');
    } finally {
      setModalLoading(false);
    }
  };
    ...
    <>
        ...
        <Row className="mb-4">
          <Col>
            <div className="d-flex justify-content-between align-items-center">
              <div>
                <h2 className="mb-1">Sticker Categories</h2>
                <p className="text-muted mb-0">Manage your sticker categories</p>
              </div>
            ...
            <Card className="shadow-sm">
              <CardBody>
                ...
                <Form onSubmit={handleSubmit}>
                  <FormGroup>
                    <Label for="name" className="fw-bold">Category Name *</Label>
                    <Input
                      type="text"
                      id="name"
                      name="name"
                      ...
                      placeholder="Enter sticker category name"
                      required
                    />
                  </FormGroup>
                    ...
                    <div className="border rounded p-3 text-center">
                      {previewImage ? (
                        ...
                        <div>
                          ...
                          <p className="text-muted mb-2">Upload sticker category image</p>
                          <Button
                            type="button"
                            color="light"
                            onClick={() => document.getElementById('imageUpload').click()}
                  ...
                  <div className="d-grid">
                    <Button 
                      type="submit" 
                      color="primary" 
                      disabled={!formData.name || (!editMode && !formData.image)}
                    >
            ...
            <Card className="shadow-sm mt-3">
              <CardBody>
                ...
                <div className="text-center">
                  ...
                  <p className="text-muted mb-0">Total Sticker Categories</p>
                </div>
              ...
              <CardBody>
                <div className="d-flex align-items-center justify-content-between mb-3">
                  <div className="d-flex align-items-center">
                    ...
                    <CardTitle tag="h5" className="mb-0">
                      All Sticker Categories ({categories.length})
                    </CardTitle>
                  </div>
                ...
                {loading ? (
                  <div className="text-center py-5">
                    ...
                    <p className="mt-3 text-muted">Loading sticker categories...</p>
                  </div>
                ) : categories.length === 0 ? (
                  <div className="text-center py-5">
                    <h5>No sticker categories found</h5>
                    <p className="text-muted">Start by creating your first sticker category</p>
                    <Button color="primary" onClick={openCreateModal}>
                      <FaPlus className="me-2" />
                      Create Category
                    </Button>
      ...
      <Modal isOpen={modalOpen} toggle={() => setModalOpen(false)} size="lg">
        <ModalHeader toggle={() => setModalOpen(false)}>
          {editMode ? 'Edit Sticker Category' : 'Create New Sticker Category'}
        </ModalHeader>
        <Form onSubmit={handleSubmit}>
          <ModalBody>
            <FormGroup>
          ...
          <ModalFooter>
            ...
            <Button
              type="submit"
              color="primary"
              disabled={modalLoading || !formData.name || (!editMode && !formData.image)}
            >
              {modalLoading ? (
                <>
        ...
        <ModalBody>
          {viewData && (
            <div className="text-center">
              ...
              <h4 className="mb-2">{viewData.name}</h4>
        ...
        <ModalBody>
          <div className="text-center">
            ...
            <p className="text-muted">
              This action will permanently delete the sticker category. This cannot be undone.
            </p>
          </div>
        </ModalBody>
        <ModalFooter>
...
export default StickerCategoryManagement;