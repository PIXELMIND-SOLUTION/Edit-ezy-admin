...
const BusinessCardList = () => {
  ...
  const fetchCards = () => {
    axios
      .get("https://api.editezy.com/api/admin/getbusinesscards")
      .then((res) => {
        if (res.data) {
          setCards(res.data);
        }
  ...
  const handleSaveChanges = () => {
    axios
      .put(`https://api.editezy.com/api/admin/updatebusinesscard/${selectedCard._id}`, editedCardData)
      .then(() => {
  ...
  const handleDelete = (id) => {
    ...
    axios
      .delete(`https://api.editezy.com/api/admin/deletebusinesscard/${id}`)
      .then(() => {
