...
const BusinessCardList = () => {
  ...
  const fetchCards = () => {
    axios
      .get("http://31.97.228.17:4061/api/admin/getbusinesscards")
      .then((res) => {
        if (res.data) {
          setCards(res.data);
        }
  ...
  const handleSaveChanges = () => {
    axios
      .put(`http://31.97.228.17:4061/api/admin/updatebusinesscard/${selectedCard._id}`, editedCardData)
      .then(() => {
  ...
  const handleDelete = (id) => {
    ...
    axios
      .delete(`http://31.97.228.17:4061/api/admin/deletebusinesscard/${id}`)
      .then(() => {
